...
const WhatsAppButton = () => {
  ...
  return (
    <a
      ...
      className="whatsapp-btn fixed bottom-6 right-6 z-50 w-14 h-14 rounded-full flex items-center justify-center shadow-lg md:bottom-6 bottom-20"
      aria-label={t('whatsapp.buttonLabel')}
    >
      {/* Paw prints that float up on hover */}
      <span className="paw-float paw-1" style={{ opacity: 0.8 }}><PawIcon size={10} /></span>
      <span className="paw-float paw-2" style={{ opacity: 0.6 }}><PawIcon size={8} /></span>
      <span className="paw-float paw-3" style={{ opacity: 0.5 }}><PawIcon size={6} /></span>
